...
class HouseService {
    ...
    static updateHouse(house) {
        console.log(`This is the added ${house}`);
        return $.ajax({
    ...
    static addRoom(id) {
        for (let house of this.houses) {
            if (house._id == id) {
                ...
                // let roomName = $(`#${house._id}-room-name`).val();
                // let roomArea = $(`#${house._id}-room-area`).val();
                // house.addRoom(roomName, roomArea);


                // console.log($(`#${house._id}-room-name`).val(), $(`#${house._id}-room-area`).val());
